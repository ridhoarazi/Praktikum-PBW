<?php 
  ...
  $query = "SELECT * FROM todolists WHERE user_id = ? AND status = ? ORDER BY created_at DESC";
            ...
            <div class="col w-auto">
              <div class="card" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <span class="badge bg-success text-white mb-2">Done</span>
                  <?php endif; ?>
                ...
                <div class="card-footer d-flex justify-content-between">
                  ...
                  <form action="./src/todolist-delete.php" method="POST">
                    <input type="hidden" name="id" value="<?= $item['id'] ?>">
                    <button type="submit" class="btn btn-danger" onclick="return confirm('Yakin mau hapus <?= $item['title'] ?>?')">
                      Delete
                    </button>
                  </form>
                </div>
